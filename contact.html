...
<main>
    ...
    <div class="container">
        <div class="d-none d-sm-block mb-5 pb-4">
            ...
            <script src="https://www.google.com/maps/d/embed?mid=1O6UAJE_W0iMxMp8pXazdODiu4M0&hl=en_US&ehbc=2E312F">
            </script>
        ...
        <div class="row">
            <div class="col-12">
                <h2 class="contact-title">Kontaktoni</h2>
            </div>
            <div class="col-lg-8">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <textarea class="form-control w-100" name="message" id="message" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Message'" placeholder=" Shenoni mesazhin"></textarea>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input class="form-control valid" name="name" id="name" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your name'" placeholder="Shenoni emrin">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <input class="form-control" name="subject" id="subject" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Subject'" placeholder="Shenoni Temen">
                            </div>
                        </div>
                    </div>
                    <div class="form-group mt-3">
                        <button type="submit" class="button button-contactForm boxed-btn">Dergo</button>
                    </div>
                </form>
            </div>
            <div class="col-lg-3 offset-lg-1">
                <div class="media contact-info">
                    ...
                    <div class="media-body">
                        <h3>Prishtina, Kosovo.</h3>
                        <p>10000 Bulevardi Bill Klinton, Prishtina</p>
                    </div>
                </div>
                <div class="media contact-info">
                    <span class="contact-info__icon"><i class="ti-tablet"></i></span>
                    <div class="media-body">
                        <h3>+383/44-444-444</h3>
                        <p>Hene deri te Premten 9am deri 6pm</p>
                    </div>
                </div>
                <div class="media contact-info">
                    <span class="contact-info__icon"><i class="ti-email"></i></span>
                    <div class="media-body">
                        <h3>support@ubtnews.com</h3>
                        <p>Mos hezitoni te na kontaktoni!</p>
                    </div>
                </div>
            </div>
        </div>
...
<footer>
                            ...
                            <div class="single-footer-caption mb-30">
                                ...
                                <div class="footer-tittle">
                                    <div class="footer-pera">
                                        <p class="info1">Te gjitha lajmet ne lidhje me UBT dhe me gjere.</p>
                                        <p class="info2">10000 Bulevardi Bill Klinton, Prishtina</p>
                                        <p class="info2">Tel: +383/44-444-444</p>
                                </div>
                                </div>
                            </div>
                        </div>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | UBT Newspaper</a>
