                ...
                <div class="container">
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3 d-none d-md-block">
                            <div class="logo">
                                <a href="index.html"><img src="Ubtlogo1.png" height="100px" width="100px" alt=""></a>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="offset-xl-1 col-lg-8">
                    <div class="about-details-cap mb-50">
                        <h4>Our Mission</h4>
                        <p>UBT offers a dynamic and innovative 21 century academic environment. UBT provides a supportive and challenging opportunity for the students, faculty and staff in participatory and self-governance setting.
                        ...
                        <p> UBT is a preeminent center of intellectual and cultural activity in Kosovo, improving the region’s quality of life through the skills, knowledge, experience and engagement of its faculty, staff, students and alumni</p>
                    </div>
                    <div class="about-details-cap mb-50">
                        <h4>Our Vision</h4>
                        <p>The UBT will be a modern and leading higher education institution in Kosovo, committed to apply excellence in teaching, learning and research within an inclusive student-centered environment through applying a multi-disciplinary approach that will contribute to the economic, social and cultural development of Kosovo and beyond

 

                            There are certain core values at UBT
                            </p>
                        <p> Sought after place to study and work
                            ...
                            Actions driven by the agreed benefits of all our stakeholders and community</p>
                    </div>
                </div>
            </div>
        </div>
